...
class SignTranslationDataset(data.Dataset):
    ...
    def __init__(
        ...
        **kwargs
        ...
        pos_file_tr = open(train_pos, "r")
        pos_file_tr = pos_file_tr.readlines()

        for row in pos_file_tr:
        ...
        pos_file_de = open(dev_pos, "r")
        pos_file_de = pos_file_de.readlines()

        for row in pos_file_de:
            row_ = row.strip().split("   ")
            dic[row_[0]] = row_[1]
        ...
        pos_file_te = open(test_pos, "r")
        pos_file_te = pos_file_te.readlines()

        for row in pos_file_te:
            row_ = row.strip().split("   ")
            dic[row_[0]] = row_[1]
